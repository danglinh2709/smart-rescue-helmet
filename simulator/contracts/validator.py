...
class ContractValidator:
    ...
    def __init__(self, schema_dir: Path) -> None:
        ...
        for message_type, filename in self._SCHEMA_FILES.items():
            ...
            try:
                ...
                raise RuntimeError(f"Cannot load contract schema: {schema_path}") from exc
    ...
    def _validate(self, message_type: str, payload: dict[str, Any]) -> None:
        errors = sorted(
    ...
    def validate_health(self, payload: dict[str, Any]) -> None:
